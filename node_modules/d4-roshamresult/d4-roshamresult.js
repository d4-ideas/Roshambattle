...
//************************************************************************************************************
// function     : d4-roshamresults.getTurnResult
// developer    : Kai
...
exports.getTurnResults = function(turnQuery, callback){
    if(typeof turnQuery != 'undefined'){
        if(typeof turnQuery.turnDate === 'undefined'){
             return callback({'error': 'Your turnQuery did not have a turnDate.'}, undefined);
        }
        if(typeof turnQuery.userID === 'undefined'){
            return callback({'error': 'Your turnQuery did not have a user.'}, undefined);
        }
