...
exports.logResult = function(battle, callback){
    ...
    modResult.create(battle, function(err, newResult){
        ...
        switch(battle.winner){
            case 0:
                roshamuser.logBattle({'userid':battle.player1, 'result':'Tie'}, function(err, result){});
                roshamuser.logBattle({'userid':battle.player2, 'result':'Tie'}, function(err, result){});
                break;
            case 1:
                roshamuser.logBattle({'userid':battle.player1, 'result':'Win'}, function(err, result){});
                roshamuser.logBattle({'userid':battle.player2, 'result':'Loss'}, function(err, result){});
                break;
            case 2:
                roshamuser.logBattle({'userid':battle.player1, 'result':'Loss'}, function(err, result){});
                roshamuser.logBattle({'userid':battle.player2, 'result':'Win'}, function(err, result){});
                break;
        }
