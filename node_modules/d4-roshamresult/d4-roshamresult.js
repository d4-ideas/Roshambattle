...
exports.getUserTurnResults = function(turnQuery, callback){
    getTurnResults(turnQuery, function(err, foundResults){
        ...
        if((typeof foundResults === 'object')&&(foundResults.length > 0)){
            ...
            if(String(foundResults[0].player1._id) === String(turnQuery.userID)){
            ...
            for(var i=0;i<foundResults.length;i++){
                if(String(foundResults[i].player1._id) === String(turnQuery.userID)){
                ...
                userResult.opponents.push({'name': newOpponent.name, 'result': newOpponent.result});
            }          
