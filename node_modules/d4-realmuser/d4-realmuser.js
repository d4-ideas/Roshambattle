    ...
    if(user){
        ...
        var gatherReturn = function(err, success){
            ...
            if(err){
                ...
                if(success.type === 'connection'){
                    
                    // add the connections to the retView
        ...
        query.exec(function(err, foundUser){
            if(err){
                ...
                if(!foundUser){
                    gatherReturn({'error': 'Nothing Returned'}, undefined);
                }
                else{
                ...
                connQuery.exec(function(err, foundConn){
                    if(err){
                        ...
                        if(!foundConn){
                            ...
                            gatherReturn(undefined, {'type': 'connection', 'object': foundConn});
                        }
                    }
                });
            }
